import{j as e}from"./jsx-runtime.D_zvdyIk.js";import{r as a}from"./index.Cd_vQiNd.js";import{g as y}from"./image.CZ2JubCq.js";import k from"./PrivacyPolicy.CLv6rZ5A.js";function C({title:d,tagline:f,description:u,logoSrc:h,screenshotSrcs:n,downloadLink:p,isComingSoon:g=!1,privacyVariant:v="notebook"}){const[l,o]=a.useState(!1),[m,c]=a.useState(!1),[t,x]=a.useState("system"),[i,b]=a.useState(!1);a.useEffect(()=>{b(!0);const r=localStorage.getItem("theme");r&&x(r)},[]),a.useEffect(()=>{if(!i)return;const r=document.documentElement,s=window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light";(t==="system"?s:t)==="dark"?r.classList.add("dark"):r.classList.remove("dark"),t!=="system"?localStorage.setItem("theme",t):localStorage.removeItem("theme")},[t,i]);const j=()=>{x(r=>r==="system"?(window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light")==="dark"?"light":"dark":r==="dark"?"light":"dark")};return a.useEffect(()=>{if(m){const r=document.createElement("script");return r.type="text/javascript",r.innerHTML=`
        (function() {
          try{
