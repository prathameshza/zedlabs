import{j as e}from"./jsx-runtime.D_zvdyIk.js";import{r as a}from"./index.Cd_vQiNd.js";import{g as j}from"./image.CZ2JubCq.js";import y from"./PrivacyPolicy.DtkAnZT9.js";function L({title:d,tagline:x,description:f,logoSrc:u,screenshotSrcs:h,downloadLink:p,isComingSoon:g=!1}){const[n,o]=a.useState(!1),[m,l]=a.useState(!1),[t,c]=a.useState("system"),[i,v]=a.useState(!1);a.useEffect(()=>{v(!0);const r=localStorage.getItem("theme");r&&c(r)},[]),a.useEffect(()=>{if(!i)return;const r=document.documentElement,s=window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light";(t==="system"?s:t)==="dark"?r.classList.add("dark"):r.classList.remove("dark"),t!=="system"?localStorage.setItem("theme",t):localStorage.removeItem("theme")},[t,i]);const b=()=>{c(r=>r==="system"?(window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light")==="dark"?"light":"dark":r==="dark"?"light":"dark")};return a.useEffect(()=>{if(m){const r=document.createElement("script");return r.type="text/javascript",r.innerHTML=`
        (function() {
          try{
